...
# TF1.15
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I /home/pmjd/Disk/anaconda3/envs/wjj/lib/python3.6/site-packages/tensorflow_core/include -I /usr/local/cuda-10.0/include -I /home/pmjd/Disk/anaconda3/envs/wjj/lib/python3.6/site-packages/tensorflow_core/include/external/nsync/public -lcudart -L /usr/local/cuda-10.0/lib64/ -ltensorflow_framework -L /home/pmjd/Disk/anaconda3/envs/wjj/lib/python3.6/site-packages/tensorflow_core -O2
